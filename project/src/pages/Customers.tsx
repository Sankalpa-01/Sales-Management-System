...
export default function Customers() {
  ...
  return (
    <div className="space-y-6 px-4 py-6 min-h-screen bg-gradient-to-br from-white to-indigo-50">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 my-4">
        ...
        <button
          ...
          className="bg-indigo-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-indigo-700 shadow-md transition"
        >
              ...
              <tr key={customer.customer_id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3 whitespace-nowrap">
                  <div className="flex space-x-3">
                    <button
                      onClick={() =>
                        handleFetchCustomerById(customer.customer_id)
                      }
            ...
            <form onSubmit={handleAddCustomer} className="space-y-4">
              ...
              <div className="mt-6 flex justify-end space-x-2">
                <button
                  ...
                  className="bg-gray-200 text-slate-700 px-4 py-2 rounded-lg hover:bg-gray-300"
                  disabled={isLoading}
                >
                  Cancel
                </button>
